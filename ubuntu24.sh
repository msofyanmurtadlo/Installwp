...
EOF
    ...
    run_task "Reload Fail2Ban" "sudo systemctl reload fail2ban"
...
install_new_website() {
    ...
    run_task "Mengubah kepemilikan direktori ke www-data" "sudo chown -R www-data:www-data /var/www/$domain"
